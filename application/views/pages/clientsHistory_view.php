          ...
          <?php if($r->client_id == $client['client_name']):?>
            <?php if($r->service_id == $s->service_price):?>
                ...
                <tr>
                    ...
                    <td><a href="<?php echo base_url('Residential/delete');?>/<?php echo $r->residential_id; ?>" class="btn btn-danger">Delete</a></td>
                </tr>
        ...
        <?php foreach($clients as $client):?>
          <?php if($c->client_id == $client['client_name']):?>
                ...
                <tr>
                    ...
                    <td><a href="<?php echo base_url('Commercial/delete')?>/<?php echo $c->commercial_id; ?>" class="btn btn-danger">Delete</a></td>
                </tr>
