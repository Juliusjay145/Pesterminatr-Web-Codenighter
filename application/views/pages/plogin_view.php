...
<body class=" blue lighten-2">
    <div id="login-page" class="row">
     ...
     <form method="POST" action="<?php echo base_url('PestControl/valid')?>">
          <div class="row">
            <div class="input-field col s12 center">
              <img src="http://localhost/project/logo/logo1.png" alt="" style="width: 40%;" class="responsive-img valign profile-image-login">
              <h1 style="font-size: 1.7rem; color: #444;">Pest Control Services</h1>
          ...
          <div class="row">
            <div class="input-field col s12">
             ...
             <center>
                <a href="<?php echo base_url('pestcontrol/register')?>">Don't have Account</a>
             </center>   
            </div>
          </div>
        </form>
