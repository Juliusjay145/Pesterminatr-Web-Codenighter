          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Create Service</h1>
              </div>
              ...
              <input type="hidden" name="service_id" class="form-control" value="<?php echo $updateService[0]['service_id']; ?>">
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="txtservice" value="<?php echo $updateService[0]['service_name']; ?> ">
                  </div>
                  <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <textarea name="txtdetails" class="form-control form-control-user" placeholder="Service Details"><?php echo $updateService[0]['service_detail']; ?></textarea>
                </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="number" class="form-control form-control-user" placeholder="Price" name="txtprice" value="<?php echo $updateService[0]['service_price']; ?>">
                  </div>
                </div>
