...
<div class="container">
        <div class="row">
            <div style="margin: 1em auto 0;" class="col-md-4 col-md-offset-6">
                ...
                <input type="hidden" name="client_id" class="form-control" value="<?php echo $changecontact[0]['client_id']; ?>">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control"  name="txtcontact" type="text" value="<?php echo $changecontact[0]['client_contact']; ?> ">
                                </div>
