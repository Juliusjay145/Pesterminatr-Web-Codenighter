    ...
    <div class="container">
        <div class="page-content-wrapper">
            <div class="page-content">
                ...
                <!-- <input type="hidden" name="pestcontrol_id" class="form-control" value="<?php echo $id; ?>"> -->
                ...
                success: function(data)
                {
                    ...
                    {   
                        eventData = {
                            ...
                            start_date       : moment($('#create_modal input[name=start_date]').val()).format('YYYY-MM-DD HH:mm:ss'),
                            end_date         : moment($('#create_modal input[name=end_date]').val()).format('YYYY-MM-DD HH:mm:ss'),
