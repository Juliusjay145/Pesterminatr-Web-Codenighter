            ...
            <div style="margin: 1em auto 0;" class="col-md-4 col-md-offset-6">
                <div class="login-card panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form method="POST" action="<?php echo base_url('clients/updatepassword')?>">
                <input type="hidden" name="client_id" class="form-control" value="<?php echo $changepass[0]['client_id']; ?>">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Old Password" name="txtpassword" type="password" value="<?php echo $changepass[0]['password']; ?> ">
                                </div>

                                <div class="form-group">
                                    <input class="form-control" placeholder="New Password" name="txtpassword" type="password" value="">
                                </div>

                                <div class="form-group">
                                    <input class="form-control" placeholder="Confirm-Password" name="txtconfirmpassword" type="password" value="">
                                </div>
