...
<div class="row">
  ...
  <center>
  <img src="http://localhost/project/logo/tude.JPG" style="width: 100px; height: 100px;" class="rounded-circle">
      	...
      	<?php foreach($pestcontrols as $pestcontrol): ?>
	      	...
	      	<div class="card mb-3">
				  <div class="card-body">
				    ...
				    <a href="<?php echo base_url(); ?>clients/show_pestcontrol/<?php echo $pestcontrol['pestcontrol_id']; ?>">View Pest Control Details</a>
				  </div>
