              ...
              <form method="POST" action="<?php echo base_url('service/addservice')?>">
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="txtservice"placeholder="First Name">
                  </div>
                  <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <textarea name="txtdetails" class="form-control form-control-user" placeholder="Service Details"></textarea>
                </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="number" class="form-control form-control-user" placeholder="Price" name="txtprice">
                  </div>
                </div>
